...
import { Breadcrumb, Button, Select, TreeSelect, Input, Icon, Modal, Menu, Dropdown, TimePicker, Tooltip } from 'antd';
...
const Tpl = ThatMain((that) => {
    ...
    const OPtionchildren = that.state.brandList.map((d, i) => <Option key={d.id}>{d.productClassifyName}</Option>)
    return (
        <ContentBox
            title="活动详情"
            breadcrumbList={['售价公示']}
            ...
            <div className='pricenotice'>
                                    ...
                                    <div onClick={(e) => {
                                        ...
                                        <div className='info'>
                                            <div className='box'>
                                                ...
                                                {
                                                    item.leaderName ? <span style={{ marginTop: "10px" }}>{item.leaderName}</span> : null
                                                }
                                            </div>
                                        </div>
                ...
                >
                    <div style={{textAlign:"center"}}>
                        分类名称：<input style={{ width: '60%',marginLeft:"10px",border:"1px solid #d9d9d9",borderRadius:"4px",height:"30px",padding:"0 10px" }} id='edit-item-input' onChange={that.productClassify} value={that.state.productClassifyNamex} /><br></br>
                        负责人：<TreeSelect
