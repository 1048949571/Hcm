            ...
            <div className='content'>
                                        ...
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginLeft: "30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[0].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[0].platform_code)} title={<div style={{ width: "100%" }}> {platform('TB',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[0].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[0].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[0].my_brand.itemcount / that.state.JingPinPTx[0].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[0].my_brand.itemcount  / that.state.JingPinPTx[0].my_brand.shopcount) < parseInt(that.state.JingPinPTx[0].jingpin_brand.itemcount / that.state.JingPinPTx[0].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[0].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[0].jingpin_brand.itemcount / that.state.JingPinPTx[0].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", margin: "0 30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[1].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[1].platform_code)} title={<div style={{ width: "100%" }}>{platform('1688',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[1].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    <h4>我的品牌</h4>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[1].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[1].my_brand.itemcount / that.state.JingPinPTx[1].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[1].my_brand.itemcount  / that.state.JingPinPTx[1].my_brand.shopcount) < parseInt(that.state.JingPinPTx[1].jingpin_brand.itemcount / that.state.JingPinPTx[1].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5></div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                    </h4>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[1].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[1].jingpin_brand.itemcount / that.state.JingPinPTx[1].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginRight: "30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[2].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[2].platform_code)} title={<div style={{ width: "100%" }}> {platform('DD',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[2].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[2].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[2].my_brand.itemcount / that.state.JingPinPTx[2].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[2].my_brand.itemcount  / that.state.JingPinPTx[2].my_brand.shopcount) < parseInt(that.state.JingPinPTx[2].jingpin_brand.itemcount / that.state.JingPinPTx[2].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[2].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[2].jingpin_brand.itemcount / that.state.JingPinPTx[2].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                    </Row>
                                        ...
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginLeft: "30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[3].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[3].platform_code)} title={<div style={{ width: "100%" }}> {platform('JD',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[3].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[3].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[3].my_brand.itemcount / that.state.JingPinPTx[3].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[3].my_brand.itemcount  / that.state.JingPinPTx[3].my_brand.shopcount) < parseInt(that.state.JingPinPTx[3].jingpin_brand.itemcount / that.state.JingPinPTx[3].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[3].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[3].jingpin_brand.itemcount / that.state.JingPinPTx[3].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", margin: "0 30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[4].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[4].platform_code)} title={<div style={{ width: "100%" }}> {platform('PDD',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[4].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    <h4>我的品牌</h4>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[4].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[4].my_brand.itemcount / that.state.JingPinPTx[4].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[4].my_brand.itemcount  / that.state.JingPinPTx[4].my_brand.shopcount) < parseInt(that.state.JingPinPTx[4].jingpin_brand.itemcount / that.state.JingPinPTx[4].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[4].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[4].jingpin_brand.itemcount / that.state.JingPinPTx[4].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginRight: "30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[5].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[5].platform_code)} title={<div style={{ width: "100%" }}> {platform('SN',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[5].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    <h4>我的品牌</h4>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[5].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[5].my_brand.itemcount / that.state.JingPinPTx[5].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[5].my_brand.itemcount  / that.state.JingPinPTx[5].my_brand.shopcount) < parseInt(that.state.JingPinPTx[5].jingpin_brand.itemcount / that.state.JingPinPTx[5].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[5].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[5].jingpin_brand.itemcount / that.state.JingPinPTx[5].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                    </Row>
                                        ...
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginLeft: "30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[6].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[6].platform_code)} title={<div style={{ width: "100%" }}> {platform('WPH',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[6].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[6].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[6].my_brand.itemcount / that.state.JingPinPTx[6].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[6].my_brand.itemcount  / that.state.JingPinPTx[6].my_brand.shopcount) < parseInt(that.state.JingPinPTx[6].jingpin_brand.itemcount / that.state.JingPinPTx[6].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[6].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[6].jingpin_brand.itemcount / that.state.JingPinPTx[6].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", margin: "0 30px" }}>
                                            <Card style={that.state.CardStyle==that.state.JingPinPTx[7].platform_code ? CardStylex : CardStyles} onClick={()=>that.CardStyle(that.state.JingPinPTx[7].platform_code)} title={<div style={{ width: "100%" }}>{platform('XY',{ float: "left", marginLeft: "80px", width: "34px", height: "34px" })} <b style={{ fontSize: "14px", color: "#666", float: "left", marginTop: " 5px", marginLeft: "10px" }}>{that.state.JingPinPTx[7].platform_name}</b></div>} bordered={false}>
                                                <div className="CardDivs" style={{ float: "left", textAlign: "left" }}>
                                                    <h4>我的品牌</h4>
                                                    ...
                                                    <h5><b>{that.state.JingPinPTx[7].my_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[7].my_brand.itemcount / that.state.JingPinPTx[7].my_brand.shopcount) : 0}个/店</b>{parseInt(that.state.JingPinPTx[7].my_brand.itemcount  / that.state.JingPinPTx[7].my_brand.shopcount) < parseInt(that.state.JingPinPTx[7].jingpin_brand.itemcount / that.state.JingPinPTx[7].jingpin_brand.shopcount) ? <img src="../../../../img/icon/under.png" alt="" /> : null}</h5>
                                                </div>
                                                <div className="CardDiv" style={{ float: "left", width: "104px", textAlign: "center" }}>
                                                    <h4>
                                                        <b className="vs">vs</b>
                                                ...
                                                <div className="CardDivs" style={{ float: "right", textAlign: "right" }}>
                                                    ...
                                                    <h5>{that.state.JingPinPTx[7].jingpin_brand.shopcount > 0 ? parseInt(that.state.JingPinPTx[7].jingpin_brand.itemcount / that.state.JingPinPTx[7].jingpin_brand.shopcount) : 0}/个店</h5>
                                                </div>
                                            </Card>
                                        </Col>
                                        {/* <Col span={7} style={{ padding: "0px", background: "rgba(255,255,255,1)", boxShadow: "0px 3px 8px 0px rgba(11,72,120,0.15)", marginRight: "30px" }}>
                ...
                <div className="contentBox" style={{ background: "#f2f2f9" }}>
                    <Row gutter={16} style={{ margin: "0" }}>
                        <Col span={14} style={{ background: "#fff",overflowX:"scroll"}}>
