        ...
        <div className='TaoBaoAppealDetails'>
            ...
            <div className='content'>
                <div className='contentTop'>
                    ...
                    <div className="contentTopDiv" style={{float: "left",width: "100%",marginBottom:"10px"}}>
                        <div>
                        {
                                that.state.detail_taobao.complaintReasonExtendEntities ? <span style={{ float: "left" }}>投诉理由：
                                    {
                                        that.state.detail_taobao.complaintReasonExtendEntities.length > 1 ? <span style={{ marginLeft: "10px", width: "50%", display: "inline-block", overflow: "hidden" }}>{that.state.detail_taobao.complaintReasonExtendEntities[1].value}</span> : <span style={{ marginLeft: "10px", width: "50%", display: "inline-block", overflow: "hidden" }}>{that.state.detail_taobao.complaintReasonExtendEntities[0].value}</span>
                                    } </span>: <span style={{ float: "left" }}>投诉理由：</span>
                            }
                        </div>
                    </div>
                    <div className="contentTopDiv">
                ...
                <div className='contentCon'>
                    ...
                    {
                        that.state.detail_taobao.log && typeof that.state.detail_taobao.log=="object"   ? <Timeline style={{ marginTop: "20px", marginLeft: "20px" }}>
                            {
                        ...
                        </Timeline> : that.state.detail_taobao.log && typeof that.state.detail_taobao.log=="string"   ? <Timeline style={{ marginTop: "20px", marginLeft: "20px" }}>
                            {
                                JSON.parse(that.state.detail_taobao.log).map((v, i) => {
                                    return <Timeline.Item key={i}>
