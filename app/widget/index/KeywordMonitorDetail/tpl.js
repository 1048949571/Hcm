  ...
  return (
    <div className="keywordMonitorDetail">
      ...
      <div className='content'>
                  ...
                  that.state.platform == "1688网" ? <img src="../../../img/icon/1688.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                    that.state.platform == "唯品会" ? <img src="../../../img/icon/vipn.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                      that.state.platform == "拼多多" ? <img src="../../../img/icon/pinduoduo.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                        that.state.platform == "京东商城" ? <img src="../../../img/icon/jd.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                          that.state.platform == "苏宁易购" ? <img src="../../../img/icon/suning.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                            that.state.platform == "闲鱼" ? <img src="../../../img/icon/xianyu.png" style={{ width: "20px", height: "20px" }} alt="" /> :
                              that.state.platform == "当当网" ? <img src="../../../img/icon/dang.png" style={{ width: "20px", height: "20px" }} alt="" /> :
        ...
        <div className='contentTop'>
          <div className="div">
            <span>日期： <DatePicker disabledDate={current => {
              return current < moment(that.state.createtimes).add(0, 'days')
            }} defaultValue={moment()} format={monthFormat} onChange={that.onmomentTime} /></span>
            <span style={{ position: "relative" }}>
              监控时间：<Select placeholder={that.state.values} value={that.state.values} firstActiveValue={that.state.values} getPopupContainer={trigger => trigger.parentNode} style={{ width: 100 }} onChange={that.onChangeTime}>
                {OPtionchildren}
              </Select>
            ...
            <span style={{ textAlign: "right" }}>
              <a style={{ marginRight: "10px" }} href={`/hcm/keyword_monitor/downLoad?platform_code=${that.state.platform_code}&keyword_id=${that.state.keyword_id}&createtime=${that.state.createtime}&key_times=${that.state.keytime}`}>
                <Button>下载数据</Button>
              </a>
