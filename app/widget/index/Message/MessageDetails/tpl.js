                        ...
                        that.state.messagetypes == "SJGSXXBG" ?
                            <div className="ChangeHeads">
                                ...
                                <div className="ChangeHeads">
                                    ...
                                    <span style={{marginLeft: "10px"}}>变更时间：{that.state.SJGSXXBG.content.change_time}</span>
                                    {
                                        that.state.types == "DEALER" || that.state.types == "SHOP" ?
                                            <span><Button onClick={that.state.types == "DEALER" ? that.JGGSXXBG_XQ : that.JGGSXXBG_XQs} className="Detailds">查看详情</Button></span>
                                            : "1"
                                    }
                            ...
                            <div className="ChangeHeads">
                                ...
                                <div className="ChangeHeads">
...

                                    {
                                        that.state.types == "DEALER" || that.state.types == "SHOP" ?
                                            <span>
                                                <Button campaign_id={that.state.HDDSH.content.campaign_id} onClick={that.state.types == "DEALER" ? that.HDSQYSH_XQ : that.HDSQYSH_XQs} className="Detailds">{that.state.HDDSH.BUTTONtit}</Button>
                                            </span> : ""
                                    }
                                ...
                                </div> : that.state.messagetypes == "DPSC" || that.state.messagetypes == "DPXZ" ? <div className="ChangeHeads">
                                    <span>{that.state.HDDSH.TS}</span>
                                    <span style={{marginLeft: "10px"}}></span>

                                    {
                                        that.state.types == "DEALER" ?
                                            <span>
                                                <Button onClick={that.DPXZSC_SX} className="Detailds">{that.state.HDDSH.BUTTONtit}</Button>
                                            </span> : ""
                                    }
                                </div>:null
                    ...
                    <div className="ChangeBody" style={{ padding: "0" }}>
                        <ul>
                            <li>
                                ...
                                <p>{that.state.HDDSH.content.notice_title}</p>
                                <p>{that.state.HDDSH.content.notice_id}</p>
