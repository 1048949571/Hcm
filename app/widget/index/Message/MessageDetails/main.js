...
class MessageDetails extends React.Component {
    ...
    DidMountText = () => {
        ...
        if (this.props.match.params.type == "HCM") {
            ...
            }else if(this.props.match.params.messagetype == "DPXZ" || this.props.match.params.messagetype == "DPSC"){
                this.setState({
                    type: 4
                })
                ajax.post('/hcm/hcmMessageCenter/Detail', {
                        ...
                        if (res.data.status == 10000) {
                            ...
                            this.setState({
                                ...
                                HDDSH: {
                                    topic: res.data.data.topic,
                                    time: moment(res.data.data.createtime).format('YYYY-MM-DD HH:mm:ss'),
                                    TS: this.props.match.params.messagetype == "DPXZ" ? "品牌方相关人员在您名下新增了店铺信息":"品牌方相关人员在您名下删除了店铺信息",
                                    BUTTONtit: "查看详情",
                                    content: {
        ...
        }else if (this.props.match.params.type == "SHOP") {
            if (this.props.match.params.messagetype == "HDSQYSH") {
                // console.log(2)
                this.setState({
                    type: 4
