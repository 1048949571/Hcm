...
//   console.log(props.Identity)
  return (
    <div className="activity-list-item" onClick={props.clicked.bind(this, `/ActivityDetails/${id}/${campaign_node}`)}>
      <Row>
        <Col span={24} className="title">{campaign_name} {props.Identity == 'HCMSUB' && wait_my == 'true'?<span style={{background:'#e6f7ff',borderRadius:'4px',border:'1px solid #91d5ff',fontSize:'12px',padding:'2px 5px',marginLeft:'5px'}}>待我审核</span>:null} </Col>
      </Row>
