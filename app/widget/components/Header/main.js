...
import {toggleCollapsed,setCurrentBrandToKefu,getBrandListToKefu,getBrandListToShop,setCurrentBrandToShop,getMenuList} from '../../../js/actions/index';
...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        ...
        brandListToShop: state.dealer.brandListToShop,
        currentBrandToShop:state.dealer.currentBrandToShop,
    }
}
const mapDispatchToProps = (dispatch, ownProps) => {
    return bindActionCreators({toggleCollapsed, getBrandList, setCurrentBrand,getBrandListToKefu,setCurrentBrandToKefu,getBrandListToShop,setCurrentBrandToShop,getMenuList},dispatch)
}
...
class Header extends React.Component{
    ...
    handleSwitchBrandToShop = value => {
        const { setCurrentBrandToShop, brandListToShop } = this.props;
        const data = brandListToShop.filter(v => v.bmcid === value)[0] || {};
