...
/***/ "./app/widget/index/Feedback/tpl.js":
/*!******************************************!*\
  !*** ./app/widget/index/Feedback/tpl.js ***!
  \******************************************/
/*! no static exports found */
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        null,
                        localStorage.logintype == 'ADMIN' ? null : React.createElement(
                            'a',
                            { href: '/index.html#/AddFeedback' },
                            React.createElement(
                                _button2.default,
                                { style: { color: '#fff' }, className: 'btn1-main addgd' },
                                React.createElement(_Component.AddIcon, { style: { paddingRight: 8 } }),
                                '\u65B0\u589E'
                            )
                        )
                    ),
                    React.createElement(Search, { onSearch: function onSearch() {
                            return that.onSearch();
                        }, onChange: function onChange(e) {
                            return that.onChange(e, 'title');
                        }, value: title, placeholder: localStorage.logintype == 'ADMIN' ? '请输入工单标题或提交用户' : '请输入工单标题', style: { width: 250 } })
                ),
                React.createElement(
                    'div',
                    { className: 'content-tab' },
                    React.createElement(_table2.default, { rowKey: 'id', pagination: false, columns: that.formatColumn(), dataSource: dataList }),
                    React.createElement(
                        'div',
                        { className: 'footer' },
                        React.createElement(
...
//# sourceMappingURL=111_03fcb4a5a329bccc10aa.js.map