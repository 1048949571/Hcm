...
/***/ "./app/widget/index/Brand/ShopDetail/tpl.js":
/*!**************************************************!*\
  !*** ./app/widget/index/Brand/ShopDetail/tpl.js ***!
  \**************************************************/
/*! no static exports found */
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                { onClick: function onClick() {
                        return that.props.inviteLinkStatus();
                    } },
                '\u83B7\u53D6\u5E94\u7528\u8BA2\u8D2D\u94FE\u63A5'
            )
        )
...
var Title = function Title(baseInfo) {
    var shopName = baseInfo.shopName,
        wangwang = baseInfo.wangwang,
        goodsnum = baseInfo.goodsnum,
        username = baseInfo.username,
        userstatus = baseInfo.userstatus,
        loyal = baseInfo.loyal,
        sales = baseInfo.sales,
        ratio = baseInfo.ratio,
        platformCode = baseInfo.platformCode,
        isauthed = baseInfo.isauthed,
        shopUrl = baseInfo.shopUrl;
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                'a',
                { target: '_blank', href: shopUrl },
                shopName
            ),
            (0, _platform2.default)(platformCode, { width: '20px', height: '20px', verticalAlign: '-3px', marginLeft: '10px' }),
            isauthed == 'AUTHED' ? React.createElement('img', { style: { paddingLeft: 10, verticalAlign: '-2px' }, src: '../../../../img/dinggou.jpg' }) : null,
            React.createElement(
                'span',
                null,
                wangwang
        ...
        React.createElement(
            'p',
            { className: 'shop-user-info' },
            React.createElement('img', { src: '../../../../img/loginuser_1s.png' }),
            '\u7528\u6237\u540D\uFF1A',
            username,
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        null,
                        '\xA5 ',
                        _lib2.default.formatThousandMoney(sales)
                    ),
                    '\u8FD130\u5929\u9500\u552E\u989D'
                ),
                React.createElement(
                    ...
                    React.createElement(
                        'p',
                        { style: { fontSize: 12 } },
                        ratio ? +ratio > 0 ? React.createElement(_icon2.default, { style: { color: '#F5222D' }, type: 'caret-up' }) : React.createElement(_icon2.default, { style: { color: '#52C41A' }, type: 'caret-down' }) : null,
                        ratio
                    ),
                    '\u73AF\u6BD4'
                )
...
var ShopInfo = function ShopInfo(baseInfo, titleList) {
    return React.createElement(
        'div',
        { className: 'baseInfo' },
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'a',
                    { target: '_blank', href: baseInfo.shopUrl },
                    baseInfo.shopName
                )
            ),
            React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'a',
                    { style: { color: '#108CEE' }, target: '_blank', href: baseInfo.shopUrl },
                    baseInfo.shopUrl
                )
            ),
            React.createElement(
            ...
            React.createElement(
                ...
                baseInfo.dealername,
                baseInfo.status && JSON.stringify(baseInfo.status) != '{}' ? React.createElement(
                    _tooltip2.default,
                    { placement: 'bottom', title: baseInfo.status.info },
                    React.createElement(
                        'span',
                        { style: { marginLeft: 10 }, className: baseInfo.status.info_type },
                        baseInfo.status.title
                    )
                ) : null
            ),
            React.createElement(
                ...
                baseInfo.productClassifyName ? baseInfo.productClassifyName.join(",") : null
            ),
            titleList.add && titleList.add.data.length ? React.createElement(
                React.Fragment,
                null,
                React.createElement(
                    _divider2.default,
                ...
                titleList.add.data.map(function (item, index) {
                    if (item.isChecked != 0) {
                        return React.createElement(
                            'li',
                            { key: index },
...
var Tpl = (0, _That2.default)(function (that) {
    var _that$state = that.state,
        ...
        titleList = _that$state.titleList,
...
//# sourceMappingURL=42_f454835c34638e5c94aa.js.map