...
/***/ "./app/widget/index/Brand/SalesReports/CONFIG.js":
/*!*******************************************************!*\
  !*** ./app/widget/index/Brand/SalesReports/CONFIG.js ***!
  \*******************************************************/
/*! no static exports found */
...
var info = exports.info = {
    day: {
        shop: {
            name: '店铺销售日报',
            title: '店铺销售数据日汇总报表',
            url: '/hcm/hcmShopMonitor/getSalesDayReport',
            case: '店铺',
            downloadUrl: '/hcm/hcmShopMonitor/getSalesDayReportForExcel',
            type: 'SHOP'
        },
        item: {
            name: '单品销售日报',
    ...
    month: {
        shop: {
            name: '店铺销售月报',
            title: '店铺销售数据月汇总报表',
            url: '/hcm/hcmShopMonitor/getSalesMonthReport',
            case: '店铺',
            downloadUrl: '/hcm/hcmShopMonitor/getSalesMonthReportForExcel',
            type: 'SHOP'
...
/***/ "./app/widget/index/Brand/SalesReports/tpl.js":
/*!****************************************************!*\
  !*** ./app/widget/index/Brand/SalesReports/tpl.js ***!
  \****************************************************/
/*! no static exports found */
...
var Tpl = (0, _That2.default)(function (that) {
    var _that$state = that.state,
        ...
        form = _that$state.form,
        header = _that$state.header,
        list = _that$state.list,
        pageNumber = _that$state.pageNumber,
    ...
    return React.createElement(
        _Layout2.default,
        {
            breadcrumbList: ['数据中心', _CONFIG.info[type][form].name],
            linkList: ['', ''],
            ...
            React.createElement(
                ...
                React.createElement(
                    _card2.default,
                    {
                        ...
                        hoverable: true,
                        title: _CONFIG.info[type][form].title
                    },
                    React.createElement(
                        'div',
                        { className: 'analysis-sheader' },
                        form == 'shop' ? React.createElement(
                            'p',
                            { className: 'msg' },
                            ...
                            React.createElement(
                                'b',
                                null,
                                '\u7070\u8272\u5E97\u94FA\u4E3A\u672A\u5B89\u88C5\u540E\u53F0\u5E94\u7528\u7684\u5E97\u94FA\u3002\u5E97\u94FA\u6570\u636E\u67D0\u65E5\u4E3A\u7A7A\uFF0C\u53EF\u80FD\u662F\u5E97\u94FA\u6CA1\u6709\u53CA\u65F6\u63D0\u62A5\u5F53\u65E5\u7684\u9500\u552E\u6570\u636E\uFF0C\u53EF\u4EE5\u7531\u5E97\u94FA\u8865\u62A5\u540E\u67E5\u770B.'
                            )
                        ) : null,
                        React.createElement(
                            'div',
                            ...
                            React.createElement(
                                _button2.default,
                                { href: _CONFIG.info[type][form].downloadUrl + '?type=' + _CONFIG.info[type][form].type + '&start_time=' + (type == 'month' ? date[0].format('YYYY-MM') : date[0].format('YYYY-MM-DD')) + '&end_time=' + (type == 'month' ? date[1].format('YYYY-MM') : date[1].format('YYYY-MM-DD')) },
                                '\u4E0B\u8F7D\u6570\u636E'
                            )
                        )
                    ),
                    React.createElement(
                        'div',
                        { className: 'tab-box' },
                        React.createElement(_table2.default, { rowKey: 'id', onRow: function onRow(record) {}, pagination: false, scroll: { x: (header.length + 1) * 150 }, columns: that.getColumns(header, list), dataSource: list, bordered: true }),
                        React.createElement(
                            'div',
                            { className: 'footer' },
                            React.createElement(
                            ...
                            React.createElement(_pagination2.default, { pageSize: pageSize, current: pageNumber, total: totalElements, onChange: that.changePagination, onShowSizeChange: that.onPaginationSize, showSizeChanger: true, showQuickJumper: true })
                        )
                    )
                )
            )
...
//# sourceMappingURL=95_f08ea5bd72e1233544d4.js.map