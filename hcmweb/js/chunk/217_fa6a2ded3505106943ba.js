...
/***/ "./app/widget/index/Administrator/DealerList/main.js":
/*!***********************************************************!*\
  !*** ./app/widget/index/Administrator/DealerList/main.js ***!
  \***********************************************************/
/*! no static exports found */
...
var _tpl = __webpack_require__(/*! ./tpl */ "./app/widget/index/Administrator/DealerList/tpl.js");
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.getList = function () {
            ...
            _ajax2.default.get('/hcm/dealer/getlistOfAdmin', {
                params: {
                    dealername: dealername, takePeople: takePeople, username: username, status: status,
                    pageNo: pageNo,
                    pageSize: pageSize
                }
        ...
        _this.formatColumn = function () {
            ...
            var column = [{
                ...
                render: function render(text, record, index) {
                    return React.createElement(
                        'a',
                        { href: '/index.html#/DealerDetail/' + record.dealer_id },
                        text
                    );
                }
            }, {
...
//# sourceMappingURL=217_fa6a2ded3505106943ba.js.map