...
/***/ "./app/widget/index/Administrator/SetDictionary/tpl.js":
/*!*************************************************************!*\
  !*** ./app/widget/index/Administrator/SetDictionary/tpl.js ***!
  \*************************************************************/
/*! no static exports found */
...
var Tpl = (0, _That2.default)(function (that) {
    ...
    return React.createElement(
        ...
        React.createElement(
            'div',
            { className: 'SetDictionary' },
            React.createElement(
                'div',
                { className: 'content' },
                React.createElement(
                    _button2.default,
                    { type: 'dashed', className: 'add', onClick: function onClick() {
                            return that.actionVisible(true);
                        } },
                    '+ \u65B0\u589E\u5B57\u5178'
                ),
                React.createElement(_table2.default, { rowKey: 'id', pagination: false, columns: columns(), dataSource: state.data })
            ),
...
var BindBoxFrom = _form2.default.create()(function (props) {
    var _props$that = props.that,
        ...
        subAdd = _props$that.subAdd;
    var _props$form = props.form,
        getFieldDecorator = _props$form.getFieldDecorator,
        resetFields = _props$form.resetFields,
        validateFields = _props$form.validateFields;

    var _state$targetData = state.targetData,
        id = _state$targetData.id,
        type = _state$targetData.type,
        parentId = _state$targetData.parentId,
        initValue = _objectWithoutProperties(_state$targetData, ['id', 'type', 'parentId']);
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                getFieldDecorator('dictName', { rules: [{ required: true, message: '请输入名称!' }], initialValue: initValue.dictName })(React.createElement(_input2.default, null))
            ),
            React.createElement(
                FormItem,
                {
                ...
                getFieldDecorator('dictCode', { rules: [{ required: true, message: '请输入Code!' }], initialValue: initValue.dictCode })(React.createElement(_input2.default, null))
            ),
            React.createElement(
                FormItem,
                {
                ...
                getFieldDecorator('sortNumber', { initialValue: initValue.sortNumber })(React.createElement(_input2.default, null))
            ),
            React.createElement(
                FormItem,
                {
                ...
                getFieldDecorator('pricename', { initialValue: initValue.pricename })(React.createElement(_input2.default, null))
            )
        )
    );
});
...
//# sourceMappingURL=69_109634e6d37a1c6c1193.js.map