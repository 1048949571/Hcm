...
/***/ "./app/widget/index/JD/JDInquiries/JDInquiries.less":
/*!**********************************************************!*\
  !*** ./app/widget/index/JD/JDInquiries/JDInquiries.less ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./app/widget/index/JD/JDInquiries/tpl.js":
/*!************************************************!*\
  !*** ./app/widget/index/JD/JDInquiries/tpl.js ***!
  \************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./JDInquiries.less */ "./app/widget/index/JD/JDInquiries/JDInquiries.less");
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            { getPopupContainer: function getPopupContainer(trigger) {
                                ...
                                }, placeholder: that.state.accountId, style: { width: 240, marginLeft: "10px" }, onChange: that.handleChange },
                            OPtionchildren
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'a',
                            { href: '/hcm/complaint/downLoad_jd?account_id=' + that.state.accountId + '&state=' + that.state.state },
                            React.createElement(
                                _button2.default,
                                { className: 'btn6' },
                                '\u4E0B\u8F7D\u6570\u636E'
                ...
                React.createElement(
                    'div',
                    { className: 'content-fot', style: { position: "relative" } },
                    React.createElement(
                        _select2.default,
                        { defaultValue: '\u5168\u90E8', getPopupContainer: function getPopupContainer(trigger) {
                                return trigger.parentNode;
                            }, style: { width: 240, marginLeft: "72px", float: "left" }, onChange: that.handleChangex },
                        React.createElement(
                            Option,
                            { value: '' },
                            '\u5168\u90E8'
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(_pagination2.default, { pageSize: that.state.pageSize, current: that.state.pageNo, total: that.state.totalNum, onChange: that.changePagination, showQuickJumper: true })
                        )
                    ),
                    React.createElement(
                        _modal2.default,
...
//# sourceMappingURL=113_7fe26007a1488eedd87f.js.map