...
/***/ "./app/widget/index/Service/LinkMarking/tpl.js":
/*!*****************************************************!*\
  !*** ./app/widget/index/Service/LinkMarking/tpl.js ***!
  \*****************************************************/
/*! no static exports found */
...
var Tpl = (0, _That2.default)(function (that) {
  ...
  var columns = [{
    ...
    render: function render(text, record) {
      return React.createElement(
        'span',
        { onClick: that.goTo.bind(that, '/linkMarkingDetail/' + text), style: { color: '#108CEE', cursor: 'pointer' } },
        text
      );
    }
  }, {
    ...
    render: function render(text, record) {
      return React.createElement(
        ...
        React.createElement('span', { className: 'vertical-line' }),
        React.createElement(
          'span',
          { className: 'item' },
          '\u672A\u6807\u8BB0\uFF1A',
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'link-marking-wrapper' },
      React.createElement(
        _row2.default,
        { className: 'title-wrapper', type: 'flex', justify: 'space-between', align: 'middle' },
        React.createElement(
          _col2.default,
          { className: 'title', span: 12 },
          '\u54C1\u724C\u5E97\u94FA\u6570\uFF1A',
          pagination.totalElements || 0
        ),
        React.createElement(
          _col2.default,
          { className: 'input', span: 12 },
          React.createElement(_input2.default, {
            onChange: that.handleInputChange,
            placeholder: '\u8BF7\u8F93\u5165\u5E97\u94FA\u540D\u79F0',
            suffix: React.createElement(_icon2.default, { style: { cursor: 'pointer' }, onClick: that.handleSearchClick, type: 'search' }) })
        )
      ),
...
//# sourceMappingURL=129_383677ac7e4723f2aa47.js.map