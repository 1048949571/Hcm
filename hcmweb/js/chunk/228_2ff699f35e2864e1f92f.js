...
/***/ "./app/widget/index/Announcements/InfoAnnouncement.js":
/*!************************************************************!*\
  !*** ./app/widget/index/Announcements/InfoAnnouncement.js ***!
  \************************************************************/
/*! no static exports found */
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.getDetail = function () {
            ...
            _ajax2.default.get('/hcm/notice/Detail', {
                params: {
                    notice_id: _this.props.match.params.id
                }
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var _data$noticeDepartsLi = data.noticeDepartsList,
                noticeDepartsList = _data$noticeDepartsLi === undefined ? [] : _data$noticeDepartsLi,
                _data$dealist = data.dealist,
                dealist = _data$dealist === undefined ? [] : _data$dealist,
                notice_send_type = data.notice_send_type,
                _data$noticeClassifys = data.noticeClassifysList,
                noticeClassifysList = _data$noticeClassifys === undefined ? [] : _data$noticeClassifys,
            ...
            return React.createElement(
                ...
                React.createElement(
                                    ...
                                    React.createElement(
                                        _tooltip2.default,
                                        {
                                            ...
                                            title: React.createElement(
                                                'div',
                                                null,
                                                dealist ? dealist.length ? React.createElement(
                                                    'p',
                                                    null,
                                                    '\u7ECF\u9500\u5546\uFF08',
                                                    dealist.length,
                                                ...
                                                React.createElement(
                                                    'ul',
                                                    null,
                                                    dealist ? dealist.map(function (item, index) {
                                                        return React.createElement(
                                                            'li',
                                                            { key: index },
                                                            item
                                                ...
                                                shoplist ? shoplist.length ? React.createElement(
                                                    'p',
                                                    null,
                                                    '\u5E97\u94FA\uFF08',
                                                    shoplist.length,
                                                ...
                                                React.createElement(
                                                    'ul',
                                                    null,
                                                    shoplist ? shoplist.map(function (item, index) {
                                                        return React.createElement(
                                                            'li',
                                                            { key: index },
                                                            item
                                        ...
                                        React.createElement(
                                            ...
                                            { className: '' },
                                            '\u5171 ',
                                            (dealist ? dealist.length : 0) + (shoplist ? shoplist.length : 0),
                                            ' \u4EBA\u672A\u8BFB'
                                        )
                                    )
                                ) : null
                    ...
                    React.createElement(
                        ...
                        React.createElement(_braftEditor2.default, editorProps)
                    ),
                    data.attach_urls.length ? React.createElement(
                        'ul',
                        { className: 'attach-urls', style: { width: '100%' } },
                        React.createElement(
                            'li',
                        ...
                        data.attach_urls.map(function (item, index) {
                            console.log(item);
                            return React.createElement(
                                'li',
                                { key: index },
                                React.createElement(_icon2.default, { type: 'paper-clip' }),
                                React.createElement(
                                    'a',
                                    { href: '/hcm/hcmWorkOrder/downLoadFile?filename=' + item.response.data.data },
                                    item.name
                                )
                            );
                        })
...
//# sourceMappingURL=228_2ff699f35e2864e1f92f.js.map