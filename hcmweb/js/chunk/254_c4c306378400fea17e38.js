...
/***/ "./app/widget/index/Brand/DepartmentManagement/main.js":
/*!*************************************************************!*\
  !*** ./app/widget/index/Brand/DepartmentManagement/main.js ***!
  \*************************************************************/
...
var _tpl = __webpack_require__(/*! ./tpl */ "./app/widget/index/Brand/DepartmentManagement/tpl.js");
...
var AddItemFrom = _form2.default.create()(function (props) {
    ...
    var removeDepartNext = function removeDepartNext() {
        ...
        var expandedKeys = new Set(props.state.expandedKeys);
        expandedKeys.delete('' + props.item.id);
        addBoxx.delete(props.item.id);
        props.state.addBox = addBoxx;
        props.state.expandedKeys = [].concat(_toConsumableArray(expandedKeys));
        props.getList();
    };
...
var DepartmentManagement = function (_React$Component) {
    ...
    function DepartmentManagement(props) {
        ...
        _this.handleOk = function () {
            if (_this.state.handleOk.subSysDepartment == null) {
                _this.setState({
                    ModalText: '你确认要删除该部门嘛？',
                    confirmLoading: true
                });
                _ajax2.default.post('/hcm/department/deleteDepartment', {
        ...
        _this.creatTreeDom = function (data) {
            ...
            return data.map(function (item, index) {
                ...
                return React.createElement(
                    TreeNode,
                    { className: item.subSysDepartment || addBox.has(item.id) ? '' : 'leaf', title: _this.titleTreeNode(item), key: item.id },
                    ...
                    item.subSysDepartment ? _this.creatTreeDom(item.subSysDepartment) : null
                );
            });
        };
        ...
        _this.BJDepartNext = function (item) {
            ...
            var expandedKeys = new Set(_this.state.expandedKeystwo);
            addBoxtwo.clear();
            expandedKeys.add('' + item.id);
            addBoxtwo.add(item.id);

            _ajax2.default.post('/hcm/userout/getDepartmentLeaderList', { //负责人
...
//# sourceMappingURL=254_c4c306378400fea17e38.js.map