...
/***/ "./app/widget/index/1688/1688Inquiries/OneSIXInquiries.less":
/*!******************************************************************!*\
  !*** ./app/widget/index/1688/1688Inquiries/OneSIXInquiries.less ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./app/widget/index/1688/1688Inquiries/tpl.js":
/*!****************************************************!*\
  !*** ./app/widget/index/1688/1688Inquiries/tpl.js ***!
  \****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./OneSIXInquiries.less */ "./app/widget/index/1688/1688Inquiries/OneSIXInquiries.less");
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            { getPopupContainer: function getPopupContainer(trigger) {
                                ...
                                }, placeholder: that.state.account_id, style: { width: 240, marginLeft: "10px" }, onChange: that.handleChange },
                            OPtionchildren
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'a',
                            { href: '/hcm/complaint/downLoad_1688?account_id=' + that.state.account_id + '&ipr_num=' + that.state.ipr_num + '&complaint_num=' + that.state.complaint_num + '&company_name=' + that.state.company_name + '&start_time=' + that.state.start_time + '&end_time=' + that.state.end_time + '&site=' + that.state.site + '&state=' + that.state.state },
                            React.createElement(
                                _button2.default,
                                { className: 'btn6', onClick: that.XZDate },
                                '\u4E0B\u8F7D\u6570\u636E'
                            )
                        )
                    )
                ...
                React.createElement(
                    _form2.default,
                    { className: 'content-con', onSubmit: that.ForgetSubmit, style: { padding: "20px 20px 50px" } },
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            ...
                            getFieldDecorator('productName', {
                                initialValue: ""
                            })(React.createElement(_input2.default, { style: { width: "150px", marginLeft: "10px", marginRight: "80px" }, suffix: !!getFieldValue("productName") ? React.createElement(_icon2.default, {
                                    type: 'close-circle',
                                    onClick: function onClick() {
                        ...
                        React.createElement(
                            ...
                            getFieldDecorator('brandName', {
                                initialValue: ""
                            })(React.createElement(_input2.default, { style: { width: "150px", marginLeft: "10px" }, suffix: !!getFieldValue("brandName") ? React.createElement(_icon2.default, {
                                    type: 'close-circle',
                                    onClick: function onClick() {
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            getFieldDecorator('DesName', {
                                initialValue: ""
                            })(React.createElement(_input2.default, { style: { width: "150px", marginLeft: "10px", marginRight: "80px" }, suffix: !!getFieldValue("DesName") ? React.createElement(_icon2.default, {
                                    type: 'close-circle',
                                    onClick: function onClick() {
                                        return that.handleClearIconClick("DesName");
                                    },
                                    style: clearIconStyle
                                }) : null, placeholder: '\u8BF7\u8F93\u5165' }))
                        ),
                        React.createElement(
                            ...
                            React.createElement(
                                _select2.default,
                                { defaultValue: '\u5168\u90E8', getPopupContainer: function getPopupContainer(trigger) {
                                        return trigger.parentNode;
                                    }, style: { width: 150, marginLeft: "10px", marginRight: "30px" }, onChange: that.handleChanges },
                                React.createElement(
                                    Option,
                                    { value: '' },
                                    '\u5168\u90E8'
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                { defaultValue: '\u5168\u90E8', getPopupContainer: function getPopupContainer(trigger) {
                                        return trigger.parentNode;
                                    }, style: { width: 240, marginLeft: "10px", marginRight: "20px", float: "right" }, onChange: that.handleChangex },
                                React.createElement(
                                    Option,
                                    { value: '' },
                                    '\u5168\u90E8'
                            ...
                            React.createElement(
                                FormItem,
                                { style: { marginLeft: "10px", marginRight: "25px", marginTop: "10px" } },
                                React.createElement(
                                    _button2.default,
                                    { htmlType: 'submit', className: 'btn6' },
                                    '\u67E5\u8BE2'
                                )
                            )
                        )
                ...
                React.createElement(
                    ...
                    React.createElement(
                        _button2.default,
                        { onClick: that.PLCS, style: { marginBottom: "10px" } },
                        '\u6279\u91CF\u64A4\u8BC9'
                    ),
...
//# sourceMappingURL=58_6dc69fcf95a45c189ccb.js.map