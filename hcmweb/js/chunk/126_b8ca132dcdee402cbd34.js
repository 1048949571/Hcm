...
/***/ "./app/widget/index/Service/DataInformationx/DataInformationx.less":
/*!*************************************************************************!*\
  !*** ./app/widget/index/Service/DataInformationx/DataInformationx.less ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./app/widget/index/Service/DataInformationx/tpl.js":
/*!**********************************************************!*\
  !*** ./app/widget/index/Service/DataInformationx/tpl.js ***!
  \**********************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./DataInformationx.less */ "./app/widget/index/Service/DataInformationx/DataInformationx.less");
...
var Tpl = (0, _That2.default)(function (that) {
    ...
    return React.createElement(
        ...
        React.createElement(
            'div',
            { className: 'DataInformationx' },
            React.createElement(
                'div',
                { className: 'ChangeHistoryBOXs' },
                React.createElement(
                    'div',
                    { className: 'ChangeHeadx' },
                    React.createElement(
                        'span',
                        null,
                        that.state.realname
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            null,
                            '\u7ED1\u5B9A\u624B\u673A\uFF1A',
                            that.state.mobile ? that.state.mobile : ""
                        ),
                        ' ',
                        React.createElement(
                            'a',
                            { onClick: that.MePhone },
                            that.state.BTNtit
                        )
                    ),
                    React.createElement('br', null),
                ...
                React.createElement(
                    'div',
                    { className: 'ChangeBodyn' },
                    that.state.data ? React.createElement(
                        'ul',
                        null,
                        that.state.data.map(function (i, k) {
                            return React.createElement(
                                'li',
                                { key: k },
                                React.createElement(
...
//# sourceMappingURL=126_b8ca132dcdee402cbd34.js.map