...
/***/ "./app/widget/components/OrderMonitorExpandContent/index.js":
/*!******************************************************************!*\
  !*** ./app/widget/components/OrderMonitorExpandContent/index.js ***!
  \******************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.less */ "./app/widget/components/OrderMonitorExpandContent/index.less");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ExpandContent = function ExpandContent(props) {
  var _props$data = props.data,
      itempic = _props$data.itempic,
      itemtitle = _props$data.itemtitle,
      itemprice = _props$data.itemprice,
      buyNum = _props$data.buyNum,
      itemskuprop = _props$data.itemskuprop,
      floorTransactionPrice = _props$data.floorTransactionPrice,
      brandName = _props$data.brandName,
      productName = _props$data.productName,
      lowpriceStatus = _props$data.lowpriceStatus,
      lowpriceType = _props$data.lowpriceType,
      lowpriceUname = _props$data.lowpriceUname,
      lowpriceTime = _props$data.lowpriceTime;
  ...
  return !!props.data ? React.createElement(
    ...
    React.createElement(
      'div',
      { className: 'left-img' },
      React.createElement('img', { src: itempic })
    ),
    React.createElement(
      'div',
    ...
    React.createElement(
      ...
      // 1待处理 2处理异常 0处理正常
      lowpriceStatus == 1 ? React.createElement(
        'div',
        { className: 'none-deal-order' },
        React.createElement(
          'div',
          { className: 'tips' },
        ...
        React.createElement(
          ...
          React.createElement(
            _button2.default,
            { onClick: props.handleOrder.bind(undefined, props.orderId, 2) },
            '\u5F02\u5E38\u8BA2\u5355'
          ),
          React.createElement(
            _button2.default,
            { onClick: props.handleOrder.bind(undefined, props.orderId, 0) },
            '\u6B63\u5E38\u8BA2\u5355'
          )
        )
      ) : lowpriceStatus == 2 ? React.createElement(
        'div',
        { className: 'exception-order' },

        // 1人工确认异常 2系统确认异常
        lowpriceType == 1 ? React.createElement(
          React.Fragment,
          null,
          React.createElement(
            'p',
            ...
            React.createElement(
              ...
              lowpriceUname,
              '\u4E8E',
              lowpriceTime ? moment(lowpriceTime).format('YYYY-MM-DD HH:mm:ss') : ' --'
            )
          ),
          React.createElement(
            'p',
          ...
          React.createElement(
            'p',
            null,
            lowpriceTime ? "于" + moment(lowpriceTime).format('YYYY-MM-DD HH:mm:ss') : '',
            '\u88AB\u7CFB\u7EDF\u9ED8\u8BA4\u5224\u5B9A\u4E3A\uFF1A\u5F02\u5E38\u8BA2\u5355'
          )
        )
      ) : lowpriceStatus == 0 ? React.createElement(
        'div',
...
/***/ "./app/widget/components/OrderMonitorExpandContent/index.less":
/*!********************************************************************!*\
  !*** ./app/widget/components/OrderMonitorExpandContent/index.less ***!
  \********************************************************************/
/*! no static exports found */
...
//# sourceMappingURL=43_1e3737599ae6bd2bc667.js.map