...
/***/ "./app/widget/index/Brand/PendingClient/main.js":
/*!******************************************************!*\
  !*** ./app/widget/index/Brand/PendingClient/main.js ***!
  \******************************************************/
...
var _tpl = __webpack_require__(/*! ./tpl */ "./app/widget/index/Brand/PendingClient/tpl.js");
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.getList = function () {
            _ajax2.default.get('/hcm/dealer/getlistVerify').then(function (response) {
        ...
        _this.getlistDealerVerify = function () {
            _ajax2.default.get('/hcm/dealer/getlistDealerVerify', {
                params: {
                    id: _this.state.id
                }
        ...
        _this.editClient = function (item, index, bl) {
            ...
            _this.setState({
                ...
                _this.getlistDealerVerify();
            });
        };

        _this.aChangeClient = function (value, index) {
            var dataList = _this.state.dataList;
        ...
        _this.onSubkit = function (item, apply_status) {

            _ajax2.default.get('/hcm/dealer/verify', {
                params: {
...
//# sourceMappingURL=265_a08e3ca78ae3e439af5b.js.map