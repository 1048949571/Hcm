...
/***/ "./app/widget/index/JD/JDAppealDetails/JDAppealDetails.less":
/*!******************************************************************!*\
  !*** ./app/widget/index/JD/JDAppealDetails/JDAppealDetails.less ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./app/widget/index/JD/JDAppealDetails/tpl.js":
/*!****************************************************!*\
  !*** ./app/widget/index/JD/JDAppealDetails/tpl.js ***!
  \****************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./JDAppealDetails.less */ "./app/widget/index/JD/JDAppealDetails/JDAppealDetails.less");
...
var baba = ["产权类型", "投诉链接", "产权名称", "产权编号", "商标注册证", "投诉时间", "当前状态", "投诉说明", "联系方式", "处理结果", "申诉材料", "其他"];
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'a',
                        { href: '/index.html#/JDInquiries', target: '_blank' },
                        '\u4EAC\u4E1C\u6295\u8BC9\u67E5\u8BE2'
                    )
                ),
                React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'h4',
                        null,
                        that.state.getJDDetail.odd_number,
                        ' ',
                        that.state.getJDDetail.odd_number_text
                    )
                )
            ),
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'contentTopDiv', style: { marginTop: "10px" } },
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'contentTopDiv', style: { marginTop: "10px" } },
                    that.state.getJDDetail.servise_infos ? React.createElement(
                        'ul',
                        null,
                        Object.entries(that.state.getJDDetail.servise_infos).map(function (v, i) {
                            return React.createElement(
                                'li',
                                { style: { marginTop: "10px" }, key: i },
                                baba.includes(v[0]) ? React.createElement(
                                    'span',
                                    null,
                                    React.createElement(
                                        'span',
                                    ...
                                    '\uFF1A',
                                    Array.isArray(v[1]) === true ? React.createElement(
                                        'span',
                                        { style: { width: "500px", display: "inline-block" } },
                                        v[1].map(function (vv, ii) {
                                            return React.createElement(
                                                'span',
                                                { key: ii },
                                                React.createElement(
                                                    'a',
                                                    { href: vv.href ? vv.href : vv },
                                                    vv.fileName ? vv.fileName : vv,
                                                    ' '
                                                ),
...
//# sourceMappingURL=112_bca478ece538b91af2bd.js.map